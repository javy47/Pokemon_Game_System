...
db.execute('INSERT INTO pokemon(name,level,type1_id,type2_id,base_hp,base_atk,base_def,base_spatk,base_spdef,base_spe) VALUES ("charizard", 5, 1,12, 78,84,78,109,85,100)')
